        ...
        <div class="sign-in">
            <div class="sign-in-box" id="signInBox">
                <form id="form">
                    ...
                    <div class="i" id="pw">
                        <input type="password" required id="confirmP" v-model="this.cPassword"> 
                        <label class="l">Confirm new password</label>
                        <span id="pwSpan"></span>
                    </div>
                    <h5 id="cPasswordLabel">{{ cPasswordError }}</h5>
                    <div class="b">
                        <input type="button" value="Change" id="signIn" @click="changePassword">
                    </div>
                    <div class="link">
        ...
        methods:{
            ...
            async changePassword(){
                ...
                if (!emailCheck){
                    ...
                    await fetch(`https://textchat-159f4-default-rtdb.firebaseio.com/users/${ourMessage}.json`, {
                        method: "DELETE",
                        headers: {
